...
mod bench {
    ...
    #[bench]
    pub fn crypto_secretbox_10(bh: &mut Bencher) {
        let key = [1u8; 32];
        let nonce = [2u8; 24];
        let msg = [3u8; 10];
        bh.iter( || {
        ...
        bh.bytes = msg.len() as u64;
    }

    #[bench]
    pub fn crypto_secretbox_1k(bh: &mut Bencher) {
        let key = [1u8; 32];
        let nonce = [2u8; 24];
        let msg = [3u8; 1024];
        bh.iter( || {
    ...
    #[bench]
    pub fn crypto_secretbox_64k(bh: &mut Bencher) {
        let key = [1u8; 32];
        let nonce = [2u8; 24];
        let msg = [3u8; 65536];
        bh.iter( || {
    ...
    #[bench]
    pub fn crypto_secretbox_open_10(bh: &mut Bencher) {
        let key = [1u8; 32];
        let nonce = [2u8; 24];
        let msg = [3u8; 10];
        let boxed = crypto_secretbox(&msg, &nonce, &key);
        bh.iter( || {
            match crypto_secretbox_open(&boxed[], &nonce, &key) {
                Ok(_) => {},
                Err(_) => panic!()
            }
        });
    ...
    #[bench]
    pub fn crypto_secretbox_open_1k(bh: &mut Bencher) {
        let key = [1u8; 32];
        let nonce = [2u8; 24];
        let msg = [3u8; 1024];
        let boxed = crypto_secretbox(&msg, &nonce, &key);
    ...
    #[bench]
    pub fn crypto_secretbox_open_64k(bh: &mut Bencher) {
        let key = [1u8; 32];
        let nonce = [2u8; 24];
        let msg = [3u8; 65536];
        let boxed = crypto_secretbox(&msg, &nonce, &key);
